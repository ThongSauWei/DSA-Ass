...
public class CourseSearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Add Course", "Search Course", "Update Course", "Delete Course" }));
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        if (evt.getItem().equals("Add Course")) {
            this.dispose();
            new CourseAdd().setVisible(true);
        } else if (evt.getItem().equals("Search Course")) {
            
        } else if (evt.getItem().equals("Update Course")) {
            this.dispose();
            new CourseUpdate().setVisible(true);
        } else if (evt.getItem().equals("Delete Course")) {
            this.dispose();

...
public class StartUp {
    ...
    public static void init() { // Used to create data if the file does not have data
        ...
        CourseProgramme courseProgramme4 = new CourseProgramme("DFT1001", programme2, course3);
        ...
        AssignmentStudent assignmentStudent1 = new AssignmentStudent("BACS2063-1001-1", assignmentTeam1, student1);
        AssignmentStudent assignmentStudent2 = new AssignmentStudent("BACS2063-1001-2", assignmentTeam1, student2);
        AssignmentStudent assignmentStudent3 = new AssignmentStudent("BACS2063-1002-1", assignmentTeam2, student3);
        AssignmentStudent assignmentStudent4 = new AssignmentStudent("BACS2063-1003-1", assignmentTeam3, student4);
        AssignmentStudent assignmentStudent5 = new AssignmentStudent("BACS2063-1003-2", assignmentTeam3, student5);
        AssignmentStudent assignmentStudent6 = new AssignmentStudent("BACS2063-1004-1", assignmentTeam4, student6);
        AssignmentStudent assignmentStudent7 = new AssignmentStudent("BACS2063-1004-2", assignmentTeam4, student7);
        AssignmentStudent assignmentStudent8 = new AssignmentStudent("BACS2063-1005-1", assignmentTeam5, student8);
